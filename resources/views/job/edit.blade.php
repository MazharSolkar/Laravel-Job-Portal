            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Update Job Details</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" name="qualifications" id="qualifications" cols="5" rows="5" placeholder="Qualifications">{{$job->qualications}}</textarea>
                            </div>
