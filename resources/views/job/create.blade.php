                    ...
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" name="qualifications" id="qualifications" cols="5" rows="5" placeholder="Qualifications">{{old('qualications')}}</textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="experience" id="experience" class="form-select">
                                    ...
                                    <option value="0 year" {{ old('experience') == '0 year' ? 'selected' : '' }}>Fresher</option>
                                    ...
                                    <option value="4_plus year" {{ old('experience') == '4_plus year' ? 'selected' : '' }}>4+ Years</option>
                                </select>
                            </div>
                            <div class="mb-4">
